...
('40202020', '10402020202', 'Jorge', 'Salazar Mena', '987111002', 'jorge.salazar@test.com', 'Jr. Las Flores 220', TRUE, TRUE),
('40303030', '10403030303', 'Lucia', 'Paredes Soto', '987111003', 'lucia.paredes@test.com', 'Calle Central 315', FALSE, TRUE),
('40404040', '10404040404', 'Miguel', 'Huaman Diaz', '987111004', 'miguel.huaman@test.com', 'Pasaje Mercado 410', TRUE, TRUE),
('40505050', '10405050505', 'Elena', 'Castillo Paz', '987111005', 'elena.castillo@test.com', 'Av. Grau 505', TRUE, FALSE),
('40606060', NULL, 'Asociacion', 'Mercado Central', '987111006', 'asociacion@test.com', 'Administracion del mercado', TRUE, TRUE);

INSERT INTO puestos (numero_puesto, pabellon, medidas, precio, estado_puesto, id_socio_actual, id_giro) VALUES
('A-001', 'A', '2x2m', 12000.00, 'OCUPADO', 1, 1),
('A-002', 'A', '2x2m', 11800.00, 'OCUPADO', 1, 1),
('A-003', 'A', '2x2m', 11500.00, 'OCUPADO', 2, 2),
('A-004', 'A', '2x2m', 11500.00, 'VACANTE', NULL, 2),
('B-001', 'B', '2x3m', 14000.00, 'OCUPADO', 3, 3),
('B-002', 'B', '2x3m', 13800.00, 'OCUPADO', 3, 3),
('B-003', 'B', '2x2m', 11000.00, 'MANTENIMIENTO', NULL, 4),
('C-001', 'C', '3x3m', 18000.00, 'OCUPADO', 4, 5),
('C-002', 'C', '3x2m', 15000.00, 'VACANTE', NULL, 5),
('C-003', 'C', '2x2m', 12500.00, 'OCUPADO', 6, 6);
