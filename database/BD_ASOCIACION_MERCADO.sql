DROP DATABASE IF EXISTS BD_SANEAMIENTO_MERCADO;
CREATE DATABASE BD_SANEAMIENTO_MERCADO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE BD_SANEAMIENTO_MERCADO;
