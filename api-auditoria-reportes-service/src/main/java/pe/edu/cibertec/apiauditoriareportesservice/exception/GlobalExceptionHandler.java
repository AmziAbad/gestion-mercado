package pe.edu.cibertec.apiauditoriareportesservice.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({ReglaNegocioException.class, ConflictoException.class})
    public ResponseEntity<ErrorResponse> business(RuntimeException ex, HttpServletRequest request) {
